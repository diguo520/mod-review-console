...
export default {
  ...
  theme: {
  	...
  	extend: {
      /* __DS_BURN_START__ */
      fontFamily: { sans: ["\"CiscoSansTT\", \"PingFang SC\", \"Hiragino Sans GB\", \"Microsoft YaHei\", \"Noto Sans SC\", Inter, Arial, sans-serif"], display: ["\"CiscoSansTT\", \"PingFang SC\", \"Hiragino Sans GB\", \"Microsoft YaHei\", \"Noto Sans SC\", Inter, Arial, sans-serif"], mono: ["\"IBM Plex Mono\", \"PingFang SC\", \"Hiragino Sans GB\", \"Microsoft YaHei\", \"Noto Sans SC\", ui-monospace, Menlo, monospace"] },
